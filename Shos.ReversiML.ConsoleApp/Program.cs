...
namespace Shos.ReversiML.ConsoleApp
{
    class Program
    {
        ...
        private const string DATA_FILEPATH = @"G:\Dropbox\Source\GitHub\Repos\Shos.Reversi.Data\Shos.Reversi.00006.csv";
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Single Prediction --> Actual value: {sampleData.Victory} | Predicted value: {predictionResult.Prediction} | Predicted scores: [{String.Join(",", predictionResult.Score)}]");
