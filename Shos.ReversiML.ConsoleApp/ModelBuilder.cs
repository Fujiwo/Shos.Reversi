...
namespace Shos_ReversiML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"G:\Dropbox\Source\GitHub\Repos\Shos.Reversi.Data\Shos.Reversi.00011.csv";
        private static string MODEL_FILEPATH = @"../../../../Shos_ReversiML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.LightGbm(labelColumnName: "Victory", featureColumnName: "Features")
